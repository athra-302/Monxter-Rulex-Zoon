...
note = "# Encrypted By Monxter Inside\n # Github : GitHub.com/athra-302\n"
logo =("""   
...
\033[1;36m============================================
\033[1;35m   \033[1;32mDEVELOPED BY   : \033[1;32mMonxter Inside
\033[1;35m   \033[1;33mFACEBOK      : \033[1;33mMonxter Inside
\033[1;36m   \033[1;35mGITHUB       :  \033[1;35mMONXTER RULEX
\033[1;32m   \033[1;36mTOOL NAME  :  \033[1;36mENCYPTED TOOL
\033[1;32m   \033[1;35mTEAM         :  \033[1;35mMONXTER-RULEX-BOYS
...
def MainMenu():
    try:
        ...
        os.system('xdg-open https://github.com/athra-302');time.sleep(5)
        print(logo)
        menu()
        try:
        ...
        if option > 0 and option <= 17:
            if option == 17:
                sys.exit("\n Thanks For Using Monxter's Tool")
            os.system('clear') # os.system('cls')
            print(logo)
        else:
            sys.exit('\n Invalid Option !')
